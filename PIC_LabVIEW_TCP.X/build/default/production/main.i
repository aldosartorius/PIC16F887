...
void Read_ADC(void){
    ...
    ADCON0 |= (unsigned char)0x2;
    while((ADCON0 & (unsigned char)0x2) == 0x2){};



    int_data = (unsigned short)((unsigned short)ADRESH<<8) + (unsigned short)ADRESL;
    scaled_float_data = (float)((float)((float)int_data*5.0f)/(float)(1023));
    scaled_temperature = scaled_float_data*1000.0f;
    scaled_temperature = scaled_temperature/10.0f;
