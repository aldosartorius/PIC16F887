...
void zero(void){
    ...
    PORTC = (unsigned char)0x3F;
}
void one(void){

    PORTC = (unsigned char)0x06;
}
void two(void){

    PORTC = (unsigned char)0x5B;
}
void three(void){

    PORTC = (unsigned char)0x4F;
}
void four(void){

    PORTC = (unsigned char)0x66;
}
void five(void){

    PORTC = (unsigned char)0x6D;
}
void six(void){

    PORTC = (unsigned char)0x7D;
}
void seven(void){

    PORTC = (unsigned char)0x07;
}
void eight(void){

    PORTC = (unsigned char)0x7F;
}
void nine(void){

    PORTC = (unsigned char)0x6F;
}
