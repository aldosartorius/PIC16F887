...
void Lcd_Cmd(char a)
{
    ...
    Lcd_SetBit(a);
    RD3 = 1;
    _delay((unsigned long)((2)*(80000000/4000.0)));
    RD3 = 0;
}
...
void ADC_Read(){
    ...
    _delay((unsigned long)((4)*(80000000/4000.0)));
    GO_nDONE = 1;
    while(GO_nDONE);

    int_data = (ADRESH<<8) + ADRESL;
    scaled_float_data =((float)(int_data*5)/(float)(1024));
    scaled_temperature = scaled_float_data*1000;
    scaled_temperature = scaled_temperature/10;
